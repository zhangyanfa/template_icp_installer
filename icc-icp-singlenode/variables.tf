...
variable "icp_install_mcm" {
  type = "string"
  description = "install mcm after icp ready"
  default = "false"
}

variable "icp_install_mcmk" {
  type = "string"
  description = "install mcmk after icp ready"
  default = "false"
}

variable "hub_cluster_url" {
  type = "string"
  description = "Hub Cluster Kubernetes API Server"
}

variable "hub_cluster_token" {
  type = "string"
